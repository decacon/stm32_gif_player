...
#ifdef IMAGES
	GIF_Player_Stop(&gif_player);


	ST7735_DrawImage(0, 0, ST7735_WIDTH, ST7735_HEIGHT, (uint16_t*)test_img_160x128);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BL_Pin LCD_CS_Pin LCD_DCX_Pin LCD_RESET_Pin */
